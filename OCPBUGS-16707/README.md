...
Created three routes with the similar hosts, one without the path and
other eith the paths defined.
...
'route1' is reported to be the older route for the host but we expect
it should report 'route2' because the hostname and paths are similar
for the route2 and route3.
...
## Setup
    ...
    ./hack/ocpbugs-16707-setup
	
## Reproducer

    % for i in $(seq 1 100); do ./reproducer/repro.sh |grep already; done
	route route1 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
	route route2 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
	route route2 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
	route route1 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
	route route2 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
	route route2 already exposes httpd-example-path-based-routes.apps.firstcluster.lab.upshift.rdu2.redhat.com and is older
